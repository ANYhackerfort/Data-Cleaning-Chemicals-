...
mlEletroID = manualMaterials['electrolyte_id']
placementML = []
...
def replaceCorrectMl(incorrect, correct): 
    ...
    bob = []
    mlGenerationMethod = manualMaterials[incorrect]
...
def writeColumn(name, row):
    manualMaterials[name] = row
    manualMaterials.to_csv(r"/Users/matthewzhang/Desktop/Mallory - Stat/empty.csv")
